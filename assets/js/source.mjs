    ...
    try {
        ...
        const items = rows.map(row => {
            ...
            return {
                ...
                Type: cells[19] ? cells[19].v : "No Data",
            };
        });
    ...
    try {
        ...
        const CouncilorData = rows.map(row => {
            ...
            return {
                ...
                address: cells[4] ? cells[4].v : 'No Data',
                contact: cells[5] ? cells[5].v : 'No Data',
                email: cells[6] ? cells[6].v : 'No Data',
            };
        });
        ...
        try {
            ...
            const CommChairData = rows.map(row => {
                ...
                return {
                    ...
                    committeeViceChair: cells[3] ? cells[3].v : 'No Data',
                    committeeMember: cells[4] ? cells[4].v : 'No Data',
                    committeeEXOff: cells[5] ? cells[5].v : 'No Data',
                    cityCouncil: cells[6] ? cells[6].v : 'No Data',
                };
            });
