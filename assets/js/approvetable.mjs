...
document.addEventListener('DOMContentLoaded', async function() {
    try {
        ...
        const sortedData = filteredData.sort((a, b) => {
            const dateA = new Date(a.dockdate);
            const dateB = new Date(b.dockdate);
            return dateB - dateA;
        });
