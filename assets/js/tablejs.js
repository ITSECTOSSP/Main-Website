        ...
        .then(data => {
            ...
            const displayData = (data, page) => {
                ...
                paginatedItems.forEach((item, index) => {
                    ...
                    row.innerHTML = `
                        ...
                        <td data-cell="SP">${item.spno}</td>
                        <td data-cell="PROPOSED">${item.proposed}</td>
                        <td data-cell="TITLE">${item.title}</td>
                        <td data-cell="AUTHOR">${item.mainIntroducer}</td>
                        <td>
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu" aria-labelledby="dropdownMenuButton${index}">
                                    <a class="dropdown-item" href="${item.pdfFile}" target="_blank">
            ...
            searchInput.addEventListener('input', function() {
                ...
                const filteredSearchData = sortedData.filter(item =>
                    ...
                    item.mainIntroducer.toLowerCase().includes(searchText)
                );
