document.addEventListener('DOMContentLoaded', function() {
            ...
            const displayData = (data, page) => {
                ...
                paginatedItems.forEach((item, index) => {
                    ...
                    row.innerHTML = `
                        ...
                        <td data-cell="PROPOSED">${item["PO No"]}</td>
                        <td data-cell="TITLE">${item.Title}</td>
                        <td data-cell="ACTION">
                            <button class="btn btn-success table-button" style="margin-left: 5px;" type="button" data-link="${item.Iframe}/edit">
 ...
 <button class="btn btn-success table-button table-button-ctc" style="margin-left: 5px;" type="button" ><svg class="icon icon-tabler icon-tabler-certificate" xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
...
</svg><par>Request Certified Copy</par></button>
                        </td>
